...
/*******************************************************************************
* Function Name: unsigned int I2C_WriteBytes(uint8_t Address, uint8_t RegisterAddr, 
    ...
    uint8_t *RegisterValue, uint8_t RegisterLen)
{
    ...
    status = I2Cm_MasterSendStart((uint32)Address, CY_SCB_I2C_WRITE_XFER, \
        I2CM_TIMEOUT);
    ...
    if(status == CY_SCB_I2C_SUCCESS)
    {
        ...
        {
            status |= I2Cm_MasterWriteByte((uint32)*RegisterValue++, \
                I2CM_TIMEOUT);
            /* Delay to allow DMP time to settle */
            vTaskDelay(10u);
        }
    }
    /* Send Stop */
...
/*******************************************************************************
* Function Name: unsigned int I2C_ReadBytes(uint8_t Address, uint8_t RegisterAddr,
    uint8_t *RegisterValue, uint8_t RegisterLen)
********************************************************************************
* Summary:
    ...
    uint8_t *RegisterValue, uint8_t RegisterLen)
{
    ...
    /* Send Stop to indicate end of communication */
    status |= I2Cm_MasterSendStop(I2CM_TIMEOUT);
